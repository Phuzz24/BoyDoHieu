      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
        ...
        <div className="flex flex-col bg-luxuryWhite dark:bg-gray-800 p-6 rounded-xl shadow-md">
              ...
              {(product.sizes || []).length > 0 ? (
                product.sizes.map((size) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-full border-2 text-sm font-semibold transition-all duration-300 transform hover:scale-105 ${
                      selectedSize === size
                ...
                <p className="text-gray-600 dark:text-gray-300">Không có kích thước</p>
              )}
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="flex gap-2">
              {(product.colors || []).length > 0 ? (
                product.colors.map((color) => (
                  <div
                    ...
                    className={`w-8 h-8 rounded-full cursor-pointer border-2 transition-all duration-300 transform hover:scale-110 ${
                      selectedColor === color ? 'border-luxuryGold scale-110' : 'border-gray-200 hover:border-luxuryGold'
                    }`}
                ...
                <p className="text-gray-600 dark:text-gray-300">Không có màu sắc</p>
              )}
            </div>
          </div>
          ...
          <Button
            ...
            className="bg-gradient-to-r from-luxuryGold to-yellow-500 text-luxuryBlack hover:bg-luxuryBlack hover:text-luxuryWhite transition-all duration-300"
          >
            Thêm vào giỏ hàng
          </Button>
        </div>
